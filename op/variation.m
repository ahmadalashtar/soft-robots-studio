...
function [offspring] = variation(pop, matPool,targetsRObstacles, robotMode)
    ...
    for i=1:2:gas.n_individuals
        ...
        [o1, o2] = crossover(p1, p2, targetsRObstacles, robotMode);   

        % mutation
        o1 = mutation(o1,targetsRObstacles, robotMode);
        o2 = mutation(o2,targetsRObstacles, robotMode);
