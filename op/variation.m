...
function [offspring] = variation(pop, matPool,targetsRObstacles)
    ...
    for i=1:2:gas.n_individuals
        ...
        [o1, o2] = crossover(p1, p2, targetsRObstacles);   

        % mutation
        o1 = mutation(o1,targetsRObstacles);
        o2 = mutation(o2,targetsRObstacles);
