...
function [pop, fit_array] = evaluate(pop, targetsRObstacles, robotMode)
    ...
    switch algorithm
        case 'ga'
            ...
            for i=1:gas.n_individuals 
                [pop(:,:,i), fitness] = calculateFitness2D(pop(:,:,i), false, targetsRObstacles);
            ...
            fit_array = checkConstraints(pop, fit_array, targetsRObstacles, robotMode);
