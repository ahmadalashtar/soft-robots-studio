            ...
            switch gas.penalty_method
                case 'static'
                    for i=1:gas.n_individuals
                        ...
                        fit_array(i,gas.fitIdx.pen) = calculateStaticPenalty(pop(:,:,index),[10 10 10 100 10 100]);
            ...
            switch bbbcs.penalty_method
                case 'static'
                    for i=1:bbbcs.N
                        ...
                        fit_array(i,bbbcs.fitIdx.pen) = calculateStaticPenalty(pop(:,:,index),[10 10 10 100 10 100]);
